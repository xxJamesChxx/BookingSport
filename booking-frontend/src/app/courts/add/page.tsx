...
import { getData, postForm } from "@/lib/api-helper";
...
export default function AddCourtPage() {
  ...
  const handleSubmit = async () => {
    ...
    const data = await postForm("/court", formData);
    setLoading(false);
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="w-full mx-auto">
        ...
        <div className="flex items-center gap-2 mb-5">
          ...
          <span className="text-sm text-gray-400">เพิ่มสนามกีฬา</span>
        </div>

        <div className="bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden">

          <div className="px-6 py-4 border-b border-gray-50">
            <p className="text-base font-medium text-gray-800">เพิ่มสนามกีฬา</p>
            <p className="text-xs text-gray-400 mt-1">กรอกข้อมูลสนามกีฬาใหม่</p>
          </div>
          ...
          <div className="px-6 py-6">
            <div className="flex flex-col gap-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="text-sm text-gray-500 mb-1.5 block">
                    ราคา/ชั่วโมง (บาท) <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="number"
