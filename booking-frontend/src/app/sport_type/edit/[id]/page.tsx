...
export default function EditRolePage() {
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        const data = await putData(`/sporttype/${id}`, { name, isActive });
        setLoading(false);
        ...
        const result = await alert("success", "บันทึกสำเร็จ", "แก้ไขประเภทกีฬาเรียบร้อยแล้ว");
        if (result.isConfirmed) {
            router.push("/sport_type");
        }
    };
        ...
        <div className="min-h-screen bg-gray-50 p-4 md:p-6">
            <div className="w-full mx-auto">
                ...
                <div className="flex items-center gap-2 mb-5">
                    ...
                    <span className="text-sm text-gray-400">แก้ไขประเภทกีฬา</span>
                </div>

                <div className="bg-white border border-gray-100 rounded-xl shadow-sm overflow-hidden">

                    <div className="px-6 py-4 border-b border-gray-50">
                        <p className="text-base font-medium text-gray-800">แก้ไขประเภทกีฬา</p>
                        <p className="text-xs text-gray-400 mt-1">แก้ไขข้อมูลประเภทกีฬา</p>
                    </div>
